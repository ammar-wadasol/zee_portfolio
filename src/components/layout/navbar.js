...
function Navbar() {
  return (
    <div>
      ...
      <div className="flex items-center justify-between w-screen px-12 py-4 mx-20 " >
      ...
      <div className="items-center justify-center px-32 py-3 m-20 text-center ">
        <p className="text-5xl">Our Proven Process
       </p>
      ...
      <div className="flex items-center justify-between px-20 py-4 mx-16 ">
        <div className="mx-4 bg-yellow-500" >
          <p className="px-12 py-4 pt-16 text-2xl text-center">
            <p className="pb-24 text-4xl">
              Image
         </p>
       In-Demand Employable Skill Sets
        ...
        <div className="mx-4 bg-yellow-500">
          <p className="px-20 py-4 pt-16 text-2xl text-center">
            <p className="pb-24 text-4xl">
              Image
         </p>
       Hands-On Project-Based Learning
        ...
        <div className="mx-8 bg-yellow-500">
          ...
          <p className="px-16 py-4 pt-16 text-2xl text-center">
      ...
      <div className="flex items-center justify-between p-12">
        ...
        <div className=" pl-96 pr-52">
          ...
          <p>
            <button className="px-5 py-2 mt-4 bg-yellow-500 ">
              Find Out More
               </button>
          </p>
